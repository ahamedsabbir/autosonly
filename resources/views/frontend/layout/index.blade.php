...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mt_30">
                    <div class="whoose--options">
                        <h3>Why Choose<br> <span> Autos Only Rentals</span></h3>
                        <!-- option  -->
                        <div class="option">
                            <h4>Long Term Rental Discounts</h4>
                            <p>We offer discounts for weekly and monthly bookings</p>
                            <p class="op--num">01</p>
                        </div>
                        <!-- option  -->
                        <div class="option">
                            <h4>Clean and Well Serviced Vehicles</h4>
                            <p>We clean and service our rental fleet as needed</p>
                            <p class="op--num">02</p>
                        </div>
                        <!-- option  -->
                        <div class="option">
                            <h4>Autos Only Burien Dealership</h4>
                            <p>We are an affiliate of Autos Only Burien a respected independent dealer</p>
                            <p class="op--num">03</p>
                        </div>
                        <!-- option  -->
                        <div class="option">
                            <h4>Dedicated Staffing</h4>
                            <p>Our staff are trained to be attentive to customer needs</p>
                            <p class="op--num">04</p>
                        </div>
                        <!-- option  -->
                        <div class="option">
                            <h4>Instant Vehicle Replacement</h4>
                            <p>We will replace your vehicle rental with another vehicle in our fleet in the event of a
                ...
                <div class="col-lg-6 mt_30">
                    <div class="posi--img--wrapper">
                        <p>Our goal is to provide a wide selection of quality cars that are budget friendly.</p>
                        <img class="choose--car-desktop" src="{{ asset('frontend') }}/assets/images/choose--car.png"
                            alt="">
                        <img class="d-none choose--car-mobile"
                            src="{{ asset('frontend') }}/assets/images/choose--car-mobile.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-6 mt_30">
                            <h3 class="title"> Latest <span>Inventory</span></h3>
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="tab--links">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-available-car-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-available-car" type="button" role="tab"
                                                aria-controls="pills-available-car" aria-selected="true">Available Cars Only
                                                (40)</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-all-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-all" type="button" role="tab"
                                                aria-controls="pills-all" aria-selected="false">All Cars (210)</button>
                                        </li>
                                    </ul>
                                </div>
                                <!-- sort--links--wrap  -->
                                <ul class="sort--links--wrap">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade" id="pills-available-car" role="tabpanel"
                        aria-labelledby="pills-available-car-tab" tabindex="0">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mt_30">
                                ...
                                <div class="car--card">
                                    <div class="img--area">
                                        <img src="{{ asset('frontend') }}/assets/images/car7.png" alt="">
                                    </div>
                                    <div class="details">
                                        <h4>Hyundai Tucson Accent</h4>
                                        <!-- rating  -->
                            ...
                            <div class="col-lg-4 col-md-6 mt_30">
                                ...
                                <div class="car--card">
                                    <div class="img--area">
                                        <img src="{{ asset('frontend') }}/assets/images/car9.png" alt="">
                                    </div>
                                    <div class="details">
                                        <h4>Hyundai Tucson Accent</h4>
                                        <!-- rating  -->
                    ...
                    <!-- rent--btn--area -->
                    <div class="rent--btn--area text-center mt_60">
                        <a href="listing.html" class="button">Rent Car</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- inventory area end  -->
    <!-- steps area start  -->
    <section class="steps--area" style="background-image: url(./assets/images/steps-bg.png);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-4 mt_20">
                    ...
                    <div class="steps--box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49 49"
                            fill="none">
                            <path
                                d="M41.7376 17.9C39.6576 8.64 31.5776 4.5 24.4975 4.5C24.4975 4.5 24.4975 4.5 24.4775 4.5C17.4175 4.5 9.35755 8.64 7.25755 17.88C4.89755 28.2 11.2175 36.94 16.9375 42.46C19.0575 44.5 21.7775 45.52 24.4975 45.52C27.2176 45.52 29.9376 44.5 32.0376 42.46C37.7576 36.94 44.0776 28.22 41.7376 17.9ZM31.0576 19.56L23.0575 27.56C22.7575 27.86 22.3775 28 21.9975 28C21.6175 28 21.2375 27.86 20.9375 27.56L17.9375 24.56C17.3575 23.98 17.3575 23.02 17.9375 22.44C18.5175 21.86 19.4775 21.86 20.0575 22.44L21.9975 24.38L28.9375 17.44C29.5175 16.86 30.4775 16.86 31.0576 17.44C31.6376 18.02 31.6376 18.98 31.0576 19.56Z"
                                fill="#FF0000" />
                        </svg>
                ...
                <div class="col-md-4 mt_20">
                    ...
                    <div class="steps--box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="49" height="49" viewBox="0 0 49 49"
                            fill="none">
                            <path
                                d="M44 16.5002C44 17.3202 43.32 18.0002 42.5 18.0002H6.5C5.68 18.0002 5 17.3202 5 16.5002C5 15.6802 5.68 15.0002 6.5 15.0002H8.54L9.3 11.3802C10.02 7.88016 11.52 4.66016 17.48 4.66016H31.52C37.48 4.66016 38.98 7.88016 39.7 11.3802L40.46 15.0002H42.5C43.32 15.0002 44 15.6802 44 16.5002Z"
                                fill="#FF0000" />
                            <path
                                d="M44.8631 27.82C44.5631 24.52 43.6831 21 37.2631 21H11.7431C5.3231 21 4.4631 24.52 4.1431 27.82L3.0231 40C2.8831 41.52 3.3831 43.04 4.4231 44.18C5.4831 45.34 6.9831 46 8.5831 46H12.3431C15.5831 46 16.2031 44.14 16.6031 42.92L17.0031 41.72C17.4631 40.34 17.5831 40 19.3831 40H29.6231C31.4231 40 31.4831 40.2 32.0031 41.72L32.4031 42.92C32.8031 44.14 33.4231 46 36.6631 46H40.4231C42.0031 46 43.5231 45.34 44.5831 44.18C45.6231 43.04 46.1231 41.52 45.9831 40L44.8631 27.82ZM18.5031 32H12.5031C11.6831 32 11.0031 31.32 11.0031 30.5C11.0031 29.68 11.6831 29 12.5031 29H18.5031C19.3231 29 20.0031 29.68 20.0031 30.5C20.0031 31.32 19.3231 32 18.5031 32ZM36.5031 32H30.5031C29.6831 32 29.0031 31.32 29.0031 30.5C29.0031 29.68 29.6831 29 30.5031 29H36.5031C37.3231 29 38.0031 29.68 38.0031 30.5C38.0031 31.32 37.3231 32 36.5031 32Z"
                                fill="#FF0000" />
                        </svg>
                    ...
                    <div class="testi--title">
                        <h3>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="49" height="52" viewBox="0 0 49 52"
                                fill="none">
                                <path
                                    d="M22.5997 0V18.9913C22.5997 27.7333 20.7164 34.9681 16.9497 40.6956C13.0325 46.4232 7.38256 50.1913 0 52V44.087C4.51994 42.8812 7.75922 40.6203 9.71786 37.3043C11.6765 34.1391 12.8065 29.9942 13.1078 24.8696H4.51994V0H22.5997ZM49 0V18.9913C49 27.7333 47.1167 34.9681 43.3501 40.6956C39.4328 46.4232 33.7829 50.1913 26.4003 52V44.087C30.9203 42.8812 34.1595 40.6203 36.1182 37.3043C38.0768 34.1391 39.2068 29.9942 39.5081 24.8696L30.9203 24.8696L30.9203 0H49Z"
                                    fill="#E2E4FD" />
                            </svg>
                        </h3>
                        <p><strong>We are world wide corporates Brand</strong> Experience the future of automotive
                            innovation with our latest car models we offer a wide range of rental cars to suit your needs.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="testi--box">
                        ...
                        <h4>MeKabirr</h4>
                        <span>Costomer </span>
                        <p>“On the Windows talking painted pasture yet its express parties use. Sure last upon he same as
                            knew next.</p>
                    </div>
                </div>
                <div class="col-md-6">
