                ...
                <div class="row">
                    <div class="col-md-8 mt_20">
                        <div class="img--area img--big">
                            <img class="w-100" src="{{ asset($car->images->first()->image_url) }}" alt="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="img--area mt_15 img--small">
                            <img class="w-100" src="{{ asset('frontend') }}/assets/images/car-white.png" alt="" />
                        </div>
                        <div class="img--area mt_15 img--small popup--box">
                            <p class="">View All</p>
                            <div class="gallery">
                                <a href="assets/images/car-white.png">
                                    <img class="w-100" src="{{ asset('frontend') }}/assets/images/car-white.png" alt="" />
                                </a>
                                <a href="assets/images/car2.png">
                                    <img class="w-100" src="{{ asset('frontend') }}/assets/images/car2.png" alt="" />
                                </a>
                                <a href="assets/images/car3.png">
                                    <img class="w-100" src="{{ asset('frontend') }}/assets/images/car3.png" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="refueling--area">
                            <div class="box">
                                ...
                                <p>
                                    ...
                                    consectetur cupidatat kogi. Et leggings fanny pack, elit
                                    bespoke vinyl art party Pitchfork selfies master
                                    cleanse.
                                </p>
                            </div>
                            <div class="box mt_40">
                                <h3>Car Wash</h3>
                                <p>
                                    Craft beer elit seitan exercitation, photo booth et
                                    8-bit kale chips proident chillwave deep v laborum.
                                    Aliquip veniam delectus, Marfa eiusmod Pinterest in do
                                    umami readymade swag. Selfies iPhone Kickstarter,
                                    drinking vinegar jean vinegar stumptown yr pop-up
                                    artisan sunt. Craft beer elit seitan exercitation, photo
                                    booth
                                </p>
                            </div>
                            <div class="box mt_40">
                            ...
                            <div class="include--area">
                                ...
                                <ul class="feature">
                                    <li>
                                        <img src="{{ asset('frontend') }}/assets/images/check.svg" alt="check-img" />
                                        <p>Audio input</p>
                                    </li>
                                    <li>
                                        <img src="{{ asset('frontend') }}/assets/images/check.svg" alt="check-img" />
                            ...
                            <div class="calendar--wrapper">
                                ...
                                <div class="offcanvas offcanvas-start d-none" tabindex="-1" id="offcanvasExample"
                                    ...
                                    <div class="offcanvas-body d-flex justify-content-center p-0">
                                        <div data-bs-toggle="calendar" id="calendar_offcanvas" class="rounded w-75">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single--review">
                                ...
                                <div class="message">
                                    ...
                                    <p>
                                        ...
                                        sollicitudin suscipit bibendum purus blandit sagittis
                                        fusce purus at. Mi ac morbi tempus amet non eu nulla
                                        diam mollis. Et suspendisse curabitur lorem vitae
                                        massa tempus amet. Vitae blandit viverra aliquam nisl.
                                    </p>
                                </div>
                            </div>
                            <!-- single--review  -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mt_30">
                ...
                <div class="car--card">
                    <div class="img--area">
                        <img src="{{ asset('frontend') }}/assets/images/car5.png" alt="" />
                    </div>
                    <div class="details">
                        ...
                        <ul class="feature">
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    y="0" viewBox="0 0 74 74" style="enable-background: new 0 0 512 512"
                                    ...
                                    <g>
                                        ...
                                        <path d="M48.07 56.87H25.93V21.1h2v33.77h18.14V21.1h2z" fill="#000000"
